...
const checker = (param, item) => {
    return {

        exists: param.includes(item),
        index: param.indexOf(item),
        allElementsAreNumbers: param.every(item => typeof item === "number"),
        someElementsAreNumbers: param.some(item => typeof item === "number"),
    }
};